...
public class ComplianceEnforcer {
    ...
    private List<RingDeviceSystemInfo> getInfoForDevices(List<String> deviceIds) {
        ...
        for (Future<RingDeviceSystemInfo> systemInfoFuture : futureList) {
            try {
                deviceInfo.add(systemInfoFuture.get());
    ...
    private List<UpdateDeviceFirmwareResponse> triggerUpdates(List<String> nonCompliantDeviceIds,
        ...
        for (String deviceId : nonCompliantDeviceIds) {
            ...
            UpdateRingTask updateRingTask = new UpdateRingTask(ringClient, updateRequest);
            Future<UpdateDeviceFirmwareResponse> futureResponse = executorService.submit(updateRingTask);
